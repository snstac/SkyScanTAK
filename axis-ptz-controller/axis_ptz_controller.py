...
class AxisPtzController(BaseMQTTPubSub):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        capture_snapshots: bool
            When False, skip JPEG snapshot threads and MQTT image topics (PTZ tracking unchanged)
        log_to_mqtt: bool
    ...
    def _config_callback(
        ...
        if "capture_snapshots" in config:
            self.capture_snapshots = bool(config["capture_snapshots"])
...
def make_controller() -> AxisPtzController:
    ...
    return AxisPtzController(
        ...
        zoom=int(os.environ.get("ZOOM", 1500)),
        ...
        capture_snapshots=ast.literal_eval(os.environ.get("CAPTURE_SNAPSHOTS", "True")),
